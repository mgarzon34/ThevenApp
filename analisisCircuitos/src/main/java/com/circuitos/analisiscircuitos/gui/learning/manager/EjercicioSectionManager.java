...
import com.circuitos.analisiscircuitos.gui.learning.manager.EjercicioSolver.SolucionAuto;
...
public class EjercicioSectionManager {
	...
	private void inicializar() {
		...
		lista.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> cargarEditor(newVal));
	...
	private void configurarProteccion() {
		EventHandler<MouseEvent> handler=k -> checkProteccion();
