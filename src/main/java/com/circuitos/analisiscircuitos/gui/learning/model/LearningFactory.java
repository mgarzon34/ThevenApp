...
/**
 * Clase Factory para generar las tarjetas de ejercicios y el HTML de un tema de teoría.
 * 
...
public class LearningFactory {
	 ...
	 * @param onAction				Acción a ejecutar al pulsar "Resolver circuito"
	...
	public static VBox crearTarjetaEjercicio(Ejercicio ej, Runnable onAction) {
		...
		btnPlay.setOnAction(k -> onAction.run());
	...
	/**
	 * Genera el código HTML asociado a un tema de teoría.
	 * 
	 * @param t				Tema teórico
