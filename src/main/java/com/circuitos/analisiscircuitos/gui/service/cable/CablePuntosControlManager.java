...
import com.circuitos.analisiscircuitos.gui.builder.CablePuntoControlFactory;
...
public class CablePuntosControlManager {
	...
	public CablePuntosControlManager(Polyline cable, Cable contenedor) {
		...
		VisualOptionsService.showAllControlElementsProperty().addListener((obs, oldVal, newVal) -> {
