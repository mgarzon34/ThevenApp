...
import com.circuitos.analisiscircuitos.gui.service.cable.CableFusionService;
import com.circuitos.analisiscircuitos.gui.service.cable.CableGeometriaUtil;
import com.circuitos.analisiscircuitos.gui.service.cable.CableInteraccionHandler;
import com.circuitos.analisiscircuitos.gui.service.cable.CablePuntosControlManager;
import com.circuitos.analisiscircuitos.gui.service.cable.CableSegmentacionService;
...
public class Cable extends Group {
	...
	private void bindListeners(PuntoConexion inicio, PuntoConexion fin) {
		ChangeListener<Number> listener=(obs, oldVal, newVal) -> actualizarCable(inicio, fin);
	...
	private void configurarAutoLimpieza(Pane zonaDibujo) {
		parentProperty().addListener((obs, oldVal, newVal) -> {
			if(oldVal instanceof Pane pane && newVal==null) {
				Platform.runLater(() -> {
