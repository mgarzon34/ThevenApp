...
public class PanelAnalisisOpcionesController {
	...
	private void configurarBotones() {
		btnThevenin.setOnAction(k -> ejecutarAnalisis("Thevenin"));
		btnNorton.setOnAction(k -> ejecutarAnalisis("Norton"));
	}
	...
	private void configurarCheckboxMiniatura() {
		...
		checkboxListener=(obs, oldVal, newVal) -> {
			if(panelAnalisisController!=null && estadoMiniaturaManaged) {
				...
				contenedor.setVisible(newVal);
				contenedor.setManaged(newVal);
				logger.info("Visibilidad miniatura cambió: "+newVal);
			}
		};
